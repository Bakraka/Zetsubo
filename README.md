# Zetsubo — Seven Deadly Sins Trial Bot
...
python3 zetsubo_deadly_sins_trial_system.py
```
...
The previous bot version is preserved as an inactive backup at
`previous_bots/seven_deadly_sins_trial_system_previous.py`.
